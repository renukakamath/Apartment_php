...
public class Custimage1 extends ArrayAdapter<String>  {
	...
	private String[] img;
	 ...
	 public Custimage1(Activity context, String[] sname, String[] pname, String[] tota , String[] qua, String[] image ) {
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
			...
			t1.setText("shop_name : "+shop_name[position]+"\nproduct_name : "+product_name[position]+"\nTotal:"+Total[position]+"\nquantity:"+quantity[position]);
